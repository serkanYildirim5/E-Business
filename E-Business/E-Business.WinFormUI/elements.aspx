<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="elements.aspx.cs" Inherits="E_Business.WinFormUI.elements" %>
			...
			<div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
				<div class="col-first">
					...
					<nav class="d-flex align-items-center">
						...
						<a href="category.aspx">Element</a>
					</nav>
				</div>
			</div>
		</div>
